$(document).ready(function() {
  ...
  function loadGroups() {
    ...
    $('#add_group_name_label')
      .text(groupManager.translateField('details_form_group_name_label') + ': ')
      .append(
        '<strong> (' +
    ...
    $groupContainers.on('show.bs.modal', function(event) {
      ...
      $thisContainer
        ...
        .text(groupManager.translateField('details_form_submit_button_delete'))
      $thisContainer
        .find('button.group-form-submit')
        .text(
          groupManager.translateField('details_form_submit_button_' + operation)
        )
      $thisContainer
        .find('.close_form')
    ...
    groupManager.subscribe(cadc.web.gms.events.onAdminAddedError, function(e) {
      $editAdminsContainer.find(LOADER_CONTAINER_SELECTOR).hide()
    ...
    groupManager.subscribe(cadc.web.gms.events.onAdminsLoadedError, function() {
      $editAdminsContainer.find(LOADER_CONTAINER_SELECTOR).hide()
    })
