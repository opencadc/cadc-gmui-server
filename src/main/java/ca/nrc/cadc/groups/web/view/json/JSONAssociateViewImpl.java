...
public class JSONAssociateViewImpl extends AbstractJSONViewImpl<Associate>
{
     ...
     * @throws JSONException    Anything that can go wrong with JSON.
     */
    @Override
    public void writeJSON(final Associate model) throws JSONException
    {
        write("id", model.getID());
        write("type", model.isUser() ? "USER" : "GROUP");
    }
}
