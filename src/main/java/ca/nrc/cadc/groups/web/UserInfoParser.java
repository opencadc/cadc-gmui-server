...
{
    /**
     * Extract the given User's name.
     * @param user      The user whose name to extract.
     * @return          String name, or null if not present.
     */
    public static String getFullName(final User user)
    {
        if (user.personalDetails != null)
        {
            return user.personalDetails.getFirstName() + " " +
                   user.personalDetails.getLastName();
        }
