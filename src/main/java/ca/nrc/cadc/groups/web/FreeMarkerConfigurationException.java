...
/**
 * FreeMarker specific Exceptions.
 */
public class FreeMarkerConfigurationException extends RuntimeException
{
    /**
     * Constructs a JCMTWebException with the specified detail message. The
    ...
    /**
     * Constructs a JCMTWebException with the specified detail message and
